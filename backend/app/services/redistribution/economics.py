...
# принимает заявку от 1 ед., но при qty < 5 ROI размывается логистикой
# перемещения, поэтому фильтруем рекомендации снизу. Можно уменьшить
# до 1 если будут SKU с очень дорогой единицей.
MIN_LOT: Final = 5
