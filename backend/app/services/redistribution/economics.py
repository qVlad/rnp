...
# Бизнес-минимум лота для рекомендации. По HAR 2026-05-19 WB технически
# принимает заявку от 1 ед. (smoke 2026-05-20 подтвердил quota=4804 на
# Краснодаре). Для live-smoke и тестирования держим = 1; при стабильной
# работе можно повысить до 3-5 чтобы фильтровать «копеечные» рекомендации.
MIN_LOT: Final = 1
