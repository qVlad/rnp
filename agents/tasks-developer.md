...
- **Тип:** mismatch · **P1** — после v0.64.5/6 сверены ВСЕ плитки vs TS-скрин.
  ...
  4. **Остаток 6 902:** «Прочие удержания» на проде = 29 892 (2 строки «Удержание»:
     22 990 на 05-21 + 6 902 на 05-24, penalty=0). TS otherDeduction = 22 990 —
     строку 6 902 TS исключает (проверено: d24=0). bonus_type_name пуст → добавлен
     в /operations для диагностики. Наш prochie=29 892 → profit 474 191 vs TS
     482 206 (−6 902 −1 113). TODO: правило исключения «Удержание».
