...
- **Тип:** parity/feature · **P1** · детальная сверка пользователя 25-31.05. Эталон TS
  ...
  - **Phase 1 (формулы+доли+компенсация+простые плитки+фронт), Phase 2 (капитализация/
    оборачиваемость/GMROI/остатки/выпадашка логистики), блокеры: opex-сумма, cogs Δ.**
