...
- **Затронутые файлы:** `frontend/src/components/WeekProfitHero.tsx`
- **Ожидаемое:** Вариант A — динамический заголовок «по твоим брендам» для manager'а
- **Минимальный фикс:** реализовано как Вариант A в TASK-LEAD-083: `WeekProfitHero.tsx:120-123` — `isManager ? "За неделю DD-DD по твоим брендам" : "За неделю DD-DD (закрыта)"`.
- **Связанные задачи:** TASK-LEAD-042 / TASK-LEAD-083
- **Статус:** Исправлено — 2026-05-26 (stale-cleanup; реализовано через TASK-LEAD-083, статус не был обновлён)
