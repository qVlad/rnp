...
Я (Codex) обязан при любой работе с БД на боевом — сначала вызвать
...
docker-compose.yml
.env / .env.example
.Codex/settings.json   permissions для агента
```
