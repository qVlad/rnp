...
- [x] **TASK-DEV-023 (P1, перенум. с 011):** Recon-алерт в AlertsBar (auto-warning при Δ>1%) — ✅ 2026-05-20, v0.7.0. Перенумерован чтобы не конфликтовать с TASK-DEV-011 (custom-метрики) из коммита 49e8c16.
